...
?>
	<div class="footer">
		...
		<?php if((isset($james_opt['contact_us']) && $james_opt['contact_us']!='') || (isset($james_opt['twitter_user']) && $james_opt['twitter_user']!='') || (isset($james_opt['footer_menu1']) && $james_opt['footer_menu1']!='') || (isset($james_opt['footer_menu2']) && $james_opt['footer_menu2']!='')) { ?>
