...
if (function_exists('register_sidebar')) {
    ...
    register_sidebar(array(
        'name' => 'Bottom 5',
        'id'   => 'footer-5-widget',
        'description'   => 'Footer 5 widget position.',
        'before_widget' => '<div id="%1$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h2>',
        'after_title'   => '</h2>'
...
function gltheme_theme_customizer( $wp_customize ) {
	...
	*/
	...
	// Promo Content & Links
		...
		$wp_customize->add_control( new gltheme_Text_Control(
			...
			array(
				...
				<p><a style="font-size: 14px;color: #ffffff;font-weight: 600;background-color: #51d2cb;border: 3px solid #51d2cb;border-radius: 5px;padding: 5px;text-decoration: none" href="https://enginetemplates.com/free-elementor-wordpress-theme-document/" target="_blank" title="Read full theme document">Documentation</a>
				<a style="font-size: 14px;color: #ffffff;font-weight: 600;background-color: #40c6cc;border: 3px solid #40c6cc;border-radius: 5px;padding: 5px;text-decoration: none" href="https://enginetemplates.com/free-wordpress-themes/" target="_blank" title="See other beauty Wordpress themes from us">See Other Themes</a></p>
	...
	border-radius: 5px;
	padding: 5px;text-decoration: none;" href="https://enginetemplates.com/themes/et-shoes-free-responsive-shoes-wordpress-theme/" target="_blank" title="Get full website like demo with PRO version">' . __( 'Get PRO License', 'gltheme' ) . '</a>
	...
	border-radius: 5px;
	padding: 5px;text-decoration: none;" href="https://enginetemplates.com/contact/" target="_blank" title="Any pre-sale questions? Contact Us">' . __( 'Contact Us', 'gltheme' ) . '</a>',
		)
    )); 
}