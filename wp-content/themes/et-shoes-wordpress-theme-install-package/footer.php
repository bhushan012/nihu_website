...
?>
    ...
    <div id="main-footer" class="main-footer">
    	...
    	<div class="container">
	        ...
	        <!-- /End 4/4 -->
	        <!-- 4/4 -->
	        <div class="four columns footer5">
	            <?php if ( !function_exists( 'dynamic_sidebar' ) || !dynamic_sidebar('footer-5-widget') ) ?>
	        </div>
	        <!-- /End 4/4 -->
	    </div>
    </div>
    <!-- /End Footer -->
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info container">
				<?php
					/**
					 * Fires before the enginetemplates footer text for footer customization.
					 *
					 * @since enginetemplates 1.0
					 */
					do_action( 'enginetemplates_credits' );
				?>
				<div class="et-footer">
					<p>
	 					<a href="https://enginetemplates.com/free-wordpress-themes/" target="_blank" title="Premium Wordpress theme" rel="author nofollow">Premium Wordpress theme</a> by <a href="https://enginetemplates.com/" target="_blank" title="Wordpress themes" rel="author nofollow">Engine Templates</a>
					</p>
			    </div>
			</div><!-- .site-info -->
